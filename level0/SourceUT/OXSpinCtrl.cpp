...
COXSpinCtrl::COXSpinCtrl(BOOL bEnable /*= TRUE*/)
	...
	m_dwClickTicks = 0;
	m_hThumbDefCursor = m_hThumbVerCursor = AfxGetApp()->LoadCursor(IDC_OXSPINVERCUR);
	m_hThumbHorCursor = AfxGetApp()->LoadCursor(IDC_OXSPINHORCUR);
#ifdef _DEBUG
